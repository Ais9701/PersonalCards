...
{
    public partial class FormLevelEducation : Form
    {
        public FormLevelEducation()
        {
            InitializeComponent();
        }
        ...
        private void FormLevelEducation_Load(object sender, EventArgs e)
        {
        ...
        private void buttonBack12_Click(object sender, EventArgs e)
        {
        ...
        private void buttonSeal12_Click(object sender, EventArgs e)
        {
            printDocument1.Print();
        }

        private void FormLevelEducation_FormClosed(object sender, FormClosedEventArgs e)
        {
